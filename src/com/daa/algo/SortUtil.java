...
public class SortUtil {
	 ...
	 * 
	 * bubble sort - compare 0 element with 1 and arrange them. then it take 1 element with 2 and arrange.
	 * so after 1st iteration largest element moved to the end of array.
	 * from next iteration onwards we will start from 0 and ignore last element as it is already in the correct position.
	 * @param t
	 */
	 ...
	 * O(n^2)
	 * 
	 * selection sort - find minimum element from 0 to n first and then swap 0th with min.
	 * So, after first iteration first element of array is sorted 
	 * after that find min from 1 to n. and repeat it
	 * 
	 * so after 1st iteration largest element moved to the end of array.
	 * from next iteration onwards we will start from 0 and ignore last element as it is already in the correct position.
	 * 
...
//			System.out.println();
	 ...
	 * 
	 * insert ith element in between 0 to i-1 position where it needed to be present.
	 * 3,1,2
	 * 
